...
public class OmsOrder implements Serializable {
    ...
    @ApiModelProperty(value = "Promotion optimization amount (promotion price, full reduction, step price)")
    private BigDecimal promotionAmount;

    @ApiModelProperty(value = "Points deducted amount")
    private BigDecimal integrationAmount;

    @ApiModelProperty(value = "Coupon deduction amount")
    private BigDecimal couponAmount;

    @ApiModelProperty(value = "The administrator background adjusts the discount amount used in the order")
    ...
    @ApiModelProperty(value = "Order type: 0->normal order; 1->seckill order")
    ...
    @ApiModelProperty(value = "Points you can get")
    private Integer integration;

    @ApiModelProperty(value = "Activity growth value")
    ...
    @ApiModelProperty(value = "Recipient's phone")
