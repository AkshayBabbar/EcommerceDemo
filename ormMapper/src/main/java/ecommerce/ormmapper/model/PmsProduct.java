...
public class PmsProduct implements Serializable {
    ...
    @ApiModelProperty(value = "Audit status: 0->unapproved; 1->approved")
    private Integer verifyStatus;

    @ApiModelProperty(value = "Sort")
    private Integer sort;

    @ApiModelProperty(value = "sale")
    ...
    @ApiModelProperty(value = "Stock Low")
    ...
    @ApiModelProperty(value = "Comma-separated product services: 1->Worry-free return; 2->Quick refund; 3->Free shipping")
    ...
    @ApiModelProperty(value = "Picture album pictures, including product pictures are limited to 5, separated by commas")
    ...
    @ApiModelProperty(value = "Activity limit")
    private Integer promotionPerLimit;

    @ApiModelProperty(value = "Promotion type: 0->use original price without promotion; 1->use promotion price; 2->use member price; 3->use step price; 4->use full discount price; 5->limited time purchase")
    private Integer promotionType;

    @ApiModelProperty(value = "brand name")
    private String brandName;

    @ApiModelProperty(value = "Commodity category name")
