...
public class UmsMemberLevel implements Serializable {
    ...
    @ApiModelProperty(value = "Growth value obtained per evaluation")
    private Integer commentGrowthPoint;
    @ApiModelProperty(value = "Is there a free shipping privilege")
    private Integer priviledgeFreeFreight;
    @ApiModelProperty(value = "Is there sign-in privilege")
    private Integer priviledgeSignIn;
    @ApiModelProperty(value = "Is there any comment to be rewarded privileges")
    private Integer priviledgeComment;
    @ApiModelProperty(value = "Do you have exclusive activity privileges")
    private Integer priviledgePromotion;
    @ApiModelProperty(value = "Is there any member price privilege")
